...
function importar (marca)
    {
        ...
        switch (marca)
            {
                case "Hot Toys":
                    datosFiguras = fs.readFileSync("./Proyecto/Datos/figuras1.json","utf-8");
                    break
                case "Bandai":
                    datosFiguras = fs.readFileSync("./Proyecto/Datos/figuras2.json","utf-8");
                    break
                case "Star Wars":
                    datosFiguras = fs.readFileSync("./Proyecto/Datos/figuras3.json","utf-8");
                    break
                default:
                    "La marca no existe";
            }
        return JSON.parse(datosFiguras);        
    };
//console.table(importar("Bandai"));

module.exports = importar(); // Y pa' que hago esto?